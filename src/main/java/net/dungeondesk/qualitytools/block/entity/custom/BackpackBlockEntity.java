...
import net.dungeondesk.qualitytools.block.entity.ImplementedInventory;
...
public class BackpackBlockEntity extends BlockEntity implements ImplementedInventory, ExtendedScreenHandlerFactory<BlockPos> {
